...
public class RexseeSMS {
    ...
    public static final String CONTENT_URI_SMS_CONVERSATIONS = "content://sms/conversations";//会话
    ...
    public String getData(String selection, int number) {
        ...
        try {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                smsBean.set_id(cursor.getString(0));
                smsBean.setThread_id(cursor.getString(1));
                smsBean.setAddress(cursor.getString(2));
                smsBean.setPerson(((cursor.getString(3) == null) ? "" : cursor
                        .getString(3)));
                smsBean.setDate(Long.parseLong(cursor.getString(4)));
                smsBean.setMsg_snippet(cursor.getString(5));
                if (i > 0)
                    rtn += ",";
                rtn += "+{";
